...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.justify-content-center.align-items-center.mb-4
      .col-auto.onTop
        img(src="@/assets/curso/images/tema1/img_3.svg" alt='AvatarTop', style="width:450px;").m-auto 
      .col-lg
        .custom_box_left.mb-5
          span.etiqueta--black En el mismo sentido, la educación debe ser un proceso basado en el respeto de los derechos y la dignidad humana. Tal como lo plantea la Ley General de Educación, la educación 
          span.etiqueta--red <b>“(…) se fundamenta en una concepción integral de la persona humana, de su dignidad, La dignidad humana de sus derechos y de sus deberes”.</b> 
    ...
    .row.d-none.d-lg-block
      .row.justify-content-center.align-items-center.p-4.mt
        .col-lg-6.mb-5
    ...
    .row.justify-content-center.align-items-center.mb-4
      .col-lg.order-2.order-lg-1
        .custom_box_right    
          ...
          a.anexo.mb-4.mb-lg-0.my-3(href="https://publicaciones.ucatolica.edu.co/pdf/libertad-sindical.pdf" target="_blank")
            .anexo__icono
              img(src="@/assets/template/icono-link.svg")
            .anexo__texto
              p <b>Enlace web.</b> Para profundizar esta temática hacer la lectura del documento: La libertad sindical en el mundo del trabajo en Colombia.
      .col-auto.onTop.order-1.order-lg-2
        img(src="@/assets/curso/images/tema1/img_6.svg" alt='AvatarTop', style="width:450px;").m-auto 
    ...
    h4.mb-5 Dimensiones del trabajo
      ...
      .col-12.col-lg-6
        .bloque-texto-d.color-secundario.p-4
          .bloque-texto-d__texto.mb-3
            i.fas.fa-quote-left
            h3.text-regular El trabajo tiene una dimensión objetiva como acción y producto, también subjetiva como proyecto y reconocimiento social
            i.fas.fa-quote-right
          .bloque-texto-d__autor 
            .h5.mb-0 Cardona y Vera, 2003
            
        p.my-5 Las relaciones que tejen las personas con respecto al trabajo, son el sustento de la configuración de la identidad colectiva e individual, las personas identifican su rol social en comparación con su quehacer, es así como se hace la división social del trabajo. Por este motivo, el trabajo también es eje estructurante de jerarquías y poderes. La relación trabajo/capital y el valor de cambio, tiene estrecha relación con el acceso a esferas como la cultura, la educación y la satisfacción de necesidades, esto significa que la remuneración por el trabajo realizado mejora la calidad de vida y que la valoración social y económica del mismo dignifica la vida de las personas trabajadoras.      
